...
public static class DbDataReaderExtension
{
    ...
    /// <param name="reader"></param>
    /// <returns></returns>
    public static Task<List<T>> ToListAsync<T>(this DbDataReader reader) where T : new() => ToListAsync<T>(reader, CancellationToken.None);
    ...
    /// <returns></returns>
    public static async Task<List<T>> ToListAsync<T>(this DbDataReader reader, CancellationToken cancellationToken) where T : new()
    {
        var res = new List<T>();
        var mapper = new Mapper<T>(reader);
    ...
    public static IAsyncEnumerable<T> ToEnumAsync<T>(this DbDataReader reader, CancellationToken cancellationToken) where T : new() =>
        new Mapper<T>(reader).MapAsync(cancellationToken);
    ...
    /// <param name="reader"></param>
    /// <returns></returns>
    public static List<T> Column<T>(this DbDataReader reader) where T : IComparable => Column<T>(reader, 0);
    ...
    public static List<T> Column<T>(this DbDataReader reader, int ordinal) where T : IComparable
    {
        ...
        while (reader.Read())
        {
            T value = reader.IsDBNull(ordinal) ? default : (T)reader.GetValue(ordinal);
            res.Add(value);
        }
        return res;
    }
    ...
    public static async Task<List<T>> ColumnAsync<T>(this DbDataReader reader, int ordinal, CancellationToken cancellationToken) where T : IComparable
    {
        ...
        {
            T value = await reader.IsDBNullAsync(ordinal, cancellationToken).ConfigureAwait(false) ? default : (T)reader.GetValue(ordinal);
            res.Add(value);
        }
        return res;
    }
